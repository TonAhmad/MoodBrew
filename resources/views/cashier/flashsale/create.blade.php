        ...
        <div class="lg:col-span-1 space-y-4">
            ...
            <div class="bg-green-50 rounded-xl p-4 border-2 border-green-200">
                <div class="text-center">
                    ...
                    <h4 class="font-medium text-green-800 mb-1">✨ AI Copywriting Active</h4>
                    <p class="text-xs text-green-700 mb-2">
                        AI akan otomatis generate copy promo yang menarik untuk flash sale Anda
                    </p>
            ...
            <div class="bg-gray-100 rounded-xl p-4 border-2 border-dashed border-gray-300">
                <div class="text-center">
                    ...
                    <p class="text-xs text-gray-500 mb-3">
                        Configure AI_API_KEY di .env untuk mengaktifkan fitur AI
                    </p>
