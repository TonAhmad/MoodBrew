                        ...
                        <div x-data="{ open: false }" class="relative">
                            <button @click="open = !open"
                                ...
                                <div class="w-8 h-8 bg-brew-gold rounded-full flex items-center justify-center">
                                    <span
                                        class="text-brew-dark font-bold text-sm">{{ substr(auth()->user()->name ?? 'U', 0, 1) }}</span>
                                </div>
                            ...
                            <div x-show="open" @click.away="open = false" x-cloak
                                ...
                                <div class="px-4 py-2 border-b">
                                    <p class="text-sm font-medium text-gray-900">{{ auth()->user()->name ?? 'User' }}
                                    </p>
